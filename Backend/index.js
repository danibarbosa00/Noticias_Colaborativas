...
//localhost:3000/noticias/:id --> RUTA PARA BUSCAR UNA NOTICIA POR EL NOMBRE DEL AUTOR
...
//localhost:3000/noticias/2/votar/positivo --> VOTAR NOTICIA POSITIVAMENTE
app.post(
...
//localhost:3000/noticias/2/votar/negativo --> VOTAR NOTICIA NEGATIVAMENTE
app.post(
...
//localhost:3000/noticias/votos/:id --> COMPROBAR EL ESTADO DEL VOTO DE UN USUARIO EN UNA NOTICIA
...
//localhost:3000/miscomentarios ---> MIS COMENTARIOS
app.get(
